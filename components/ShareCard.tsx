      ...
      >
        ...
        <div className="relative w-full h-full bg-[#09090b] rounded-[23px] overflow-hidden flex flex-col">
          ...
          <div className="p-8 pb-10 flex flex-col items-center relative z-10">
            ...
            <div className="w-full bg-gradient-to-b from-white/[0.08] to-transparent border border-white/10 rounded-2xl p-8 mb-4 flex flex-col items-center relative overflow-hidden shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)]">
